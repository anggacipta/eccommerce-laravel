                                ...
                                <form action="{{ route('active.vendor.approve') }}" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->username }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->name }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->email }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->phone }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->address }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->vendor_join }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <p class="font-md fw-bold text-dark">{{ $inactive_vendor_details->short_info }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
