            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('update.slider') }}" method="post" enctype="multipart/form-data" id="myForm">
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ asset($slider->slider_image) }}" alt=""
                                                 class="avatar-sm img-thumbnail" height="200px" width="200px">
                                        </div>
                                    </div>
                                    <div class="row">
